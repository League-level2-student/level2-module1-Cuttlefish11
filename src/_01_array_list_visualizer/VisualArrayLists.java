...
public class VisualArrayLists implements ActionListener {
	...
	public void addThingsToList() {
		...
		list.add("Artemis Fowl");
		list.add("The Arctic Incident");
		list.add("The Fowl scheme");
		list.add("The Opal Deception");
		list.add("The Lost Colony");
		// 2. Set one item in our list to be something different
		list.set(2, "The Eternity Code");
		...
		if (list.contains("The Lost Colony")) {
			System.out.println("Book 5 is in the list!");
		}
